...
void draw_symbol(int x, int y, char symb) {
  switch (symb) {
    ...
    case ',':
      ...
      break;
    case '.':
      gfx_line(x + 2, y + 6, x + 2, y + 7);
      break;
    case ':':
      gfx_line(x + 2, y + 1, x + 2, y + 2);
      gfx_line(x + 2, y + 5, x + 2, y + 6);
      break;
  }
}
